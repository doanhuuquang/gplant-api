    ...
    public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : IdentityDbContext<User, Role, Guid>(options)
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Order>(e =>
            {
                ...
                e.Property(x => x.ShippingAddress).IsRequired().HasMaxLength(500);
                e.Property(x => x.ShippingWard).IsRequired().HasMaxLength(100);
                e.Property(x => x.ShippingDistrict).IsRequired().HasMaxLength(100);
                e.Property(x => x.ShippingProvince).IsRequired().HasMaxLength(100);
